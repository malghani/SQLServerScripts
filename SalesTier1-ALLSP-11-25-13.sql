...
/****** Object:  StoredProcedure [dbo].[SSRS_SalesTier1_Channel_Revenue_By_Product]    Script Date: 11/26/2013 09:36:39 ******/
SET ANSI_NULLS ON
GO
...
/****** Object:  StoredProcedure [dbo].[SSRS_SalesTier1_Channel_Revenue_By_Product_Category]    Script Date: 11/26/2013 09:36:39 ******/
SET ANSI_NULLS ON
GO
...
/****** Object:  StoredProcedure [dbo].[SSRS_SalesTier1_GetDailyDataCommissions_prior_yr]    Script Date: 11/26/2013 09:36:40 ******/
SET ANSI_NULLS ON
GO
...
/****** Object:  StoredProcedure [dbo].[SSRS_SalesTier1_Gross_Monthly_Account_Performance]    Script Date: 11/26/2013 09:36:40 ******/
SET ANSI_NULLS ON
GO
...
/****** Object:  StoredProcedure [dbo].[SSRS_SalesTier1_Gross_Monthly_Account_Performance_Detail]    Script Date: 11/26/2013 09:36:40 ******/
SET ANSI_NULLS ON
GO
...
/****** Object:  StoredProcedure [dbo].[SSRS_SalesTier1_LOB_Product_Variance_by_Count]    Script Date: 11/26/2013 09:36:40 ******/
SET ANSI_NULLS ON
GO
...
/****** Object:  StoredProcedure [dbo].[SSRS_SalesTier1_LOB_Revenue_By_Category]    Script Date: 11/26/2013 09:36:40 ******/
SET ANSI_NULLS ON
GO
...
CREATE PROC [dbo].[SSRS_SalesTier1_LOB_Revenue_By_Category]  
@LOB nvarchar(320)=NULL
AS
SELECT 
  ISNULL(LOB, 'No LOB') AS LOB, 
  ISNULL(Super_Category, 'No Category') AS Product_Category,
...
/****** Object:  StoredProcedure [dbo].[SSRS_SalesTier1_LOB_Revenue_By_Prod]    Script Date: 11/26/2013 09:36:40 ******/
SET ANSI_NULLS ON
GO
...
/****** Object:  StoredProcedure [dbo].[SSRS_SalesTier1_LOB_Revenue_Pacing]    Script Date: 11/26/2013 09:36:40 ******/
SET ANSI_NULLS ON
GO
...
/****** Object:  StoredProcedure [dbo].[SSRS_SalesTier1_LOB_Revenue_Trend]    Script Date: 11/26/2013 09:36:40 ******/
SET ANSI_NULLS ON
GO
...
@AccountGroup nvarchar(320) = NULL
AS
-- SSRS_SalesTier1_LOB_Revenue_Trend 'Agency Services', 'No Account Group'
Declare @Month int
Declare @Year int
...
/****** Object:  StoredProcedure [dbo].[SSRS_SalesTier1_Month_Account_Performance_to_Plan_by_Account]    Script Date: 11/26/2013 09:36:40 ******/
SET ANSI_NULLS ON
GO
...
/****** Object:  StoredProcedure [dbo].[SSRS_SalesTier1_Month_Account_Performance_to_Plan_by_Account_Group]    Script Date: 11/26/2013 09:36:40 ******/
SET ANSI_NULLS ON
GO
...
/****** Object:  StoredProcedure [dbo].[SSRS_SalesTier1_Month_Account_Performance_to_Plan_by_Product]    Script Date: 11/26/2013 09:36:40 ******/
SET ANSI_NULLS ON
GO
...
/****** Object:  StoredProcedure [dbo].[SSRS_SalesTier1_Month_Account_Performance_to_Plan_by_Rep]    Script Date: 11/26/2013 09:36:40 ******/
SET ANSI_NULLS ON
GO
...
/****** Object:  StoredProcedure [dbo].[SSRS_SalesTier1_NET_Monthly_Account_Performance]    Script Date: 11/26/2013 09:36:40 ******/
SET ANSI_NULLS ON
GO
...
@AccountGroup nvarchar(320)=NULL,
@Account nvarchar(320)=NULL
-- [SSRS_SalesTier1_NET_Monthly_Account_Performance] 'Agency Services', 'Adam Ouart'
AS 
SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED
SET NOCOUNT ON
Declare @Month int
...
SELECT	lob=ISNULL(Monthly.lob, 'No LOB'),
		...
		monthdt= convert(int, CASE 
			...
			END),								   
		--[count]=Count(DISTINCT admclicod + admacccod + admagrcod + admagrsfx),		
	[count]=Count(Distinct CASE admtrntyp 	WHEN 'CUR' THEN admclicod + admacccod + admagrcod + admagrsfx END)-
    Count(Distinct CASE admtrntyp 	WHEN 'CAN' THEN admclicod + admacccod + admagrcod + admagrsfx END)+
    Count(Distinct CASE admtrntyp 	WHEN 'REN' THEN admclicod + admacccod + admagrcod + admagrsfx END),
...
/****** Object:  StoredProcedure [dbo].[SSRS_SalesTier1_Product_Contract_Count]    Script Date: 11/26/2013 09:36:40 ******/
SET ANSI_NULLS ON
GO
...
/****** Object:  StoredProcedure [dbo].[SSRS_SalesTier1_Production_Report]    Script Date: 11/26/2013 09:36:40 ******/
SET ANSI_NULLS ON
GO
...
/****** Object:  StoredProcedure [dbo].[SSRS_SalesTier1_Production_Variance_by_Count]    Script Date: 11/26/2013 09:36:41 ******/
SET ANSI_NULLS ON
GO
...
/****** Object:  StoredProcedure [dbo].[SSRS_SalesTier1_Production_Variance_By_Revenue]    Script Date: 11/26/2013 09:36:41 ******/
SET ANSI_NULLS ON
GO
...
/****** Object:  StoredProcedure [dbo].[SSRS_SalesTier1_Revenue_By_Channel]    Script Date: 11/26/2013 09:36:41 ******/
SET ANSI_NULLS ON
GO
...
/****** Object:  StoredProcedure [dbo].[SSRS_SalesTier1_Revenue_Trend]    Script Date: 11/26/2013 09:36:41 ******/
SET ANSI_NULLS ON
GO
...
/****** Object:  StoredProcedure [dbo].[SSRS_SalesTier1_RevenueDisbursementsByLOB]    Script Date: 11/26/2013 09:36:41 ******/
SET ANSI_NULLS ON
GO
