...
GO
IF EXISTS(Select * from sys.objects where name = 'DT0')
	drop table DT0

IF EXISTS(Select * from sys.objects where name = 'DT1')
  drop table DT1
  
IF EXISTS(Select * from sys.objects where name = 'DT2')
  drop table DT2

IF EXISTS(Select * from sys.objects where name = 'DT3')
  drop table DT3

IF EXISTS(Select * from sys.objects where name = 'DT4')
  drop table DT4
  
IF EXISTS(Select * from sys.objects where name = 'DTCombined')
  drop table DTCombined

IF EXISTS(Select * from sys.objects where name = 'Final')
  drop table Final
  
IF EXISTS(Select * from sys.objects where name = 'ETLResults')
...
INNER JOIN TestAccounts TA ON TA.ADMACCOD = D.ADMACCCOD
WHERE d.ADMEFRTYN = 'Y' and d.ADMPSTDAT = 0
...
INSERT INTO [SAL002_Tier1_Sales]
           ([APVALPVAL]
           ,[ADMPSTDAT]
           ,[ADMCLICOD]
           ,[ADMACCCOD]
...
--select count(*) from SAL002_Tier1_Sales_YTD (NOLOCK) Where ADMACCCOD IN (0000027355, 0000027356,0000027357, 0000027583)

--select * from SAL002_Tier1_Sales Where ADMACCCOD IN (0000026514, 0000026939)
--select * from SAL002_Tier1_Sales_YTD Where ADMACCCOD IN (0000026939)
